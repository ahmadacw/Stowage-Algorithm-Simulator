...
REGISTER_ALGORITHM(_314636663_a)


_314636663_a::_314636663_a() {
}
_314636663_a::~_314636663_a() {

}

void _314636663_a::resetAlgorithms() {
	parser = Parser();
	numOperations = 0;
	route = {};
	plan = { {} };
...
int _314636663_a::readShipPlan(const std::string& full_path_and_file_name) {
...
int _314636663_a::readShipRoute(const std::string& full_path_and_file_name) {
...
int _314636663_a::setWeightBalanceCalculator(WeightBalanceCalculator& calculator) {
...
std::vector<Instruction>  _314636663_a::calcMovesToLoad(std::vector<int>* listOfIndx, vector<Instruction>& instruction) {
...
int  _314636663_a::moveContainer(int curHeight, int Curx, int Cury, vector<Instruction>& instructions) {
	mat* plan = ship->getPlan();
...
std::vector<Instruction>  _314636663_a::calcMovesTounLoad(vector<Instruction>& instruction) {
...
std::vector<Instruction>  _314636663_a::calcStowage() {
...
int _314636663_a::getInstructionsForCargo(
